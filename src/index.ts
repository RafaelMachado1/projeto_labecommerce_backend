...
//Post Create Product 
// Este endpoint serve para cadastrar um novo produto
...
//Get All Products Search funcionalidade 2
...
//Put Product by id 
// Este endpoint serve para editar os dados do produto através do seu id 
...
//Este endpoint serve para criar um novo pedido de compra
...
//Este endpoint serve para deletar um pedido de compra.
...
//Get Purchase by id
//Este endpoint serve para buscar o pedido através do id do pedido
